...
document.title = "Transtheoretical model";
	
var test = [
	["A step of Transtheoretical where the person do not acknowledge that there is a problem",
	"Precontemplation" , // answer
	"StagesOfModel"], // group
	["A step of Transtheoretical where the person are now more aware of the pros and cons",
	"Contemplation" , // answer
	"StagesOfModel"], // group
	["A step of Transtheoretical where the person is getting ready to change",
	"Determination" , // answer
	"StagesOfModel"], // group
	["A step of Transtheoretical where the person taking smaller steps towards change and starts acquiring new healthy behaviors",
	"Action" , // answer
	"StagesOfModel"], // group
	["A step of Transtheoretical where the person returened to their old habits",
	"Relapse" , // answer
	"StagesOfModel"], // group
	["A step of Transtheoretical where the person succesfully avoided any temptations",
	"Maintenance" , // answer
	"StagesOfModel"], // group
	["A step of Transtheoretical where the person have no desire to return to their unhealthy behaviors",
	"Termination" , // answer
	"StagesOfModel"], // group
